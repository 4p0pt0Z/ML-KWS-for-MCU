...
const q7_t CNN_TRADPOOL2_SMALL_LIN::conv1_wt[CONV1_KX*CONV1_KY*CONV1_OUT_CH]=CONV1_WEIGHT;
const q7_t CNN_TRADPOOL2_SMALL_LIN::conv1_bias[CONV1_OUT_CH]=CONV1_BIAS;
const q7_t CNN_TRADPOOL2_SMALL_LIN::conv2_wt[CONV2_IN_CH*CONV2_KX*CONV2_KY*CONV2_OUT_CH]=CONV2_WEIGHT;
const q7_t CNN_TRADPOOL2_SMALL_LIN::conv2_bias[CONV2_OUT_CH]=CONV2_BIAS;
const q7_t CNN_TRADPOOL2_SMALL_LIN::final_fc_wt[FINAL_FC_IN_DIM*OUT_DIM]=OUTPUT_WEIGHT;
const q7_t CNN_TRADPOOL2_SMALL_LIN::final_fc_bias[OUT_DIM]=OUTPUT_BIAS;
