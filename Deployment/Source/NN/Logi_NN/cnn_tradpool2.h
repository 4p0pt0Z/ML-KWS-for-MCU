...
#define MAX_POOL2_KX 1
#define MAX_POOL2_KY 1
#define MAX_POOL2_PX 0
#define MAX_POOL2_PY 0
#define MAX_POOL2_SX 1
#define MAX_POOL2_SY 1
#define MAX_POOL2_OUT_X ((int16_t)((MAX_POOL2_IN_X + 2*MAX_POOL2_PX - (MAX_POOL2_KX - 1) -1)/MAX_POOL2_SX +1))
#define MAX_POOL2_OUT_Y ((int16_t)((MAX_POOL2_IN_Y + 2*MAX_POOL2_PY - (MAX_POOL2_KY - 1) -1)/MAX_POOL2_SY +1))
#define MAX_POOL2_OUT_LSHIFT 0
...
// g++ -E ..\Source\NN\Logi_NN\cnn_tradpool2.h
// https://www.onlinegdb.com/online_c++_compiler

/*
#define STR(x) #x
#define XSTR(x) STR(x)
#pragma message before
#pragma message XSTR(CONV2_OUT_Y)
#pragma message XSTR(CONV2_OUT_X)
#pragma message done */
